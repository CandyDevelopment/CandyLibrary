...
import fit.d6.candy.bukkit.nms.v1_18_R2.item.BukkitBlockInput;
import fit.d6.candy.bukkit.nms.v1_18_R2.item.BukkitItemInput;
import fit.d6.candy.bukkit.nms.v1_18_R2.nbt.*;
...
public class NmsAccessorV1_18_R2 implements NmsAccessor {
    ...
    public Location getArgumentBlockPosition(Object context, String name) throws CommandSyntaxException {
        return NmsUtilsV1_18_R2.toBukkit(BlockPosArgument.getLoadedBlockPos((CommandContext<CommandSourceStack>) context, name));
    }

    @Override
    public Location getArgumentSpawnableBlockPosition(Object context, String name) throws CommandSyntaxException {
        return NmsUtilsV1_18_R2.toBukkit(BlockPosArgument.getSpawnablePos((CommandContext<CommandSourceStack>) context, name));
    }
    ...
    public RootCommandNode<?> getRootCommandNode() {
        return ((CraftServer) Bukkit.getServer()).getServer().getCommands().getDispatcher().getRoot();
    }
