package fit.d6.candy.bukkit.nms.v1_18_R2.item;

import fit.d6.candy.api.item.BlockInput;
import fit.d6.candy.bukkit.nms.v1_18_R2.NmsUtilsV1_18_R2;
...
public class BukkitBlockInput implements BlockInput {
    ...
    public @NotNull Block place(@NotNull Location location, int flags) {
        this.nmsInput.place(((CraftWorld) location.getWorld()).getHandle(), NmsUtilsV1_18_R2.toBlockPos(location), flags);
