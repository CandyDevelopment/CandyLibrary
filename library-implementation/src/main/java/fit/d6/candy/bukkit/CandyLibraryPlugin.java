...
import fit.d6.candy.bukkit.collection.BukkitCollectionService;
import fit.d6.candy.bukkit.command.BukkitCommandService;
import fit.d6.candy.bukkit.configuration.BukkitConfigurationService;
import fit.d6.candy.bukkit.database.BukkitDatabaseService;
import fit.d6.candy.bukkit.event.BukkitEventService;
import fit.d6.candy.bukkit.exception.ServiceNotExistsException;
import fit.d6.candy.bukkit.gui.BukkitGuiService;
import fit.d6.candy.bukkit.item.BukkitItemService;
...
import fit.d6.candy.bukkit.scheduler.BukkitSchedulerService;
import fit.d6.candy.bukkit.time.BukkitTimeService;
import fit.d6.candy.bukkit.util.Ref;
import fit.d6.candy.bukkit.visual.BukkitVisualService;
import fit.d6.candy.bukkit.world.BukkitWorldService;
