package fit.d6.candy.bukkit.nms.v1_17_R1;
...
import fit.d6.candy.bukkit.command.argument.AttributeArgumentType;
...
import fit.d6.candy.bukkit.nms.v1_17_R1.item.BukkitBlockInput;
import fit.d6.candy.bukkit.nms.v1_17_R1.item.BukkitItemInput;
import fit.d6.candy.bukkit.nms.v1_17_R1.nbt.*;
...
public class NmsAccessorV1_17_R1 implements NmsAccessor {
    ...
    public Location getArgumentBlockPosition(Object context, String name) throws CommandSyntaxException {
        return NmsUtilsV1_17_R1.toBukkit(BlockPosArgument.getLoadedBlockPos((CommandContext<CommandSourceStack>) context, name));
    }

    @Override
    public Location getArgumentSpawnableBlockPosition(Object context, String name) throws CommandSyntaxException {
        return NmsUtilsV1_17_R1.toBukkit(BlockPosArgument.getSpawnablePos((CommandContext<CommandSourceStack>) context, name));
    }
