package fit.d6.candy.bukkit.nms.v1_17_R1.item;

import fit.d6.candy.api.item.BlockInput;
import fit.d6.candy.bukkit.nms.v1_17_R1.NmsUtilsV1_17_R1;
...
public class BukkitBlockInput implements BlockInput {
    ...
    public @NotNull Block place(@NotNull Location location, int flags) {
        this.nmsInput.place(((CraftWorld) location.getWorld()).getHandle(), NmsUtilsV1_17_R1.toBlockPos(location), flags);
